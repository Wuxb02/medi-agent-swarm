...
DB = os.path.join(ROOT, "memory", "data", "sessions.db")
MV_DB = os.path.join(ROOT, "memory", "data", "session_vectors.db")
MD_DIR = os.path.join(ROOT, "memory", "swarm", "session_summaries")
