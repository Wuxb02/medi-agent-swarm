...
from eval.config import REPORTS_DIR, THRESHOLDS
...
async def main():
    ...
    if args.score_abtest:
        from eval.evaluators.abtest_eval import compute_abtest_scores
    ...
    if needs_coordinator:
        from eval.helpers import isolated_coordinator
