...
from mediZJ.agents.consultation_agent import ConsultationAgent
from mediZJ.agents.diagnostic_agent import DiagnosticAgent
from mediZJ.agents.research_agent import ResearchAgent
...
def _make_full_agent(agent_cls):
    ...
    with patch("mediZJ.core.llm_client.AsyncOpenAI", autospec=True):
        agent = agent_cls()
    return agent
