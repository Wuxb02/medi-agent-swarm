...
from mediZJ.core import LLMClient, AgentLoop
...
class BaseAgent(ABC):
    ...
    def _register_base_tools(self):
        ...
        注意：question_for_user（交互式问卷）仅由 LeadAgent 在 clarify 阶段使用，
        Worker Agent 不注册该工具，确保只有 LeadAgent 能触发问卷。
        """
        from mediZJ.core.tools import create_activate_skill_tool
